...
impl Visitor for IgnoreVisitor {
    ...
    fn visit_composite(self, _value: &mut types::Composite<'_>) -> Result<Self::Value, Self::Error> {
        Ok(())
    }
    ...
    fn visit_bitsequence(self, _value: &mut types::BitSequence<'_>) -> Result<Self::Value, Self::Error> {
        Ok(())
    }
}
